...
<div class="page-content">
    ...
    <div class="row four-form" bis_skin_checked="1">
                ...
                <div class="card-body" bis_skin_checked="1">
                    ...
                    <form action="" method="POST" id="categoryForm">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="name" placeholder="Name" name="name" oninput="updateSlug()">
                        </div>
                        <div class="mb-3">
        ...
        <script>
            // Hàm tự động cập nhật slug khi nhập name
            function updateSlug() {
                var nameInput = document.getElementById('name');
                var slugInput = document.getElementById('slug');

                // Chuyển đổi tên thành slug bằng cách thay thế khoảng trắng bằng dấu gạch ngang
                slugInput.value = nameInput.value.toLowerCase().replace(/\s+/g, '-');
            }

            // Hàm xóa toàn bộ nội dung nhập trong form
            function clearForm() {
                var form = document.getElementById('categoryForm');
                form.reset();
                updateSlug(); // Cập nhật slug sau khi xóa
            }
        </script>
    ...
    <iframe id="websiteFrame" style="width: 100%; height: 100%" src="" frameborder="0"></iframe>
</div>
